...
*** chronometrist.el
    ...
    15. Variable - chronometrist-after-in-functions
    16. Variable - chronometrist-before-out-functions
    17. Variable - chronometrist-after-out-functions
    18. Function - chronometrist-run-functions-and-clock-in (task)
