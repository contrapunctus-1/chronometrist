...
*** Legend of currently-used time formats
    | 1. | list-date                          | (year month day)                    |
    | 2. | list-time/list-duration            | (hours minutes seconds)             |
    | 3. | (Emacs) encode-time AKA UNIX epoch | (sec-high sec-low microsec picosec) |
    | 4. | seconds                            | seconds as an integer               |
    | 5. | minutes                            | minutes as an integer               |
    | 6. | iso-timestamp                      | "YYYY-MM-DDTHH:MM:SSZ"              |
...
*** chronometrist-time.el
    ...
    7. Function - chronometrist-iso-date->timestamp (date)
