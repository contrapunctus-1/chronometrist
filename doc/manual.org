...
*** chronometrist-common.el
    ...
    6. Function - chronometrist-common-plist-date-match-p (plist date)
...
*** chronometrist-time.el
    ...
    3. Function - chronometrist-timestamp->iso-date (timestamp)
    ...
    15. Function - chronometrist-timestamp-less-p (ts1 ts2)
    16. Function - chronometrist-time-less-or-equal-p (t1 t2)
    17. Function - chronometrist-calendrical->date (date)
    18. Function - chronometrist-interval (event)
        * event -> encode-time
