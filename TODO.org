...
4. [ ] Tag-sensitive key suggestions, tag-sensitive value suggestions...?
   ...
   * Lack of task-sensitive value suggestions (#3) is an inconsistency, because tags and keys are already task-sensitive. Tag-sensitive key and value suggestions are a whole different beast, in that regard.
